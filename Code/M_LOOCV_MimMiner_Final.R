...
Method_k = "M1_15"#M1_10/M1_15/M1_03

Methods = c(Method_k, paste0(Method_k,"2"), paste0(Method_k,"3"), paste0(Method_k,"23"))
# E.g., Method_k = "M1_15" --> Methods = c("M1_152", "M1_153", "M1_1523")


delta = 0.5
gamma = 0.5#gamma
# for(delta in c(0.1,0.3, 0.7, 0.9)){#0.1, 
# for(gamma in c(0.1,0.3,0.5,0.7, 0.9)){#0.1,   
