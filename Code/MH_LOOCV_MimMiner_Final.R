# k=15
Method_k = Method_k = "H1_03"#H1_10/H1_15/H1_03

Methods = c(Method_k, paste0("M",Method_k,"2"), paste0("M",Method_k,"3"), paste0("M",Method_k,"23"))
...
for(Method in Methods){
  ...
  if(Method == paste0("M",Method_k,"23")){
